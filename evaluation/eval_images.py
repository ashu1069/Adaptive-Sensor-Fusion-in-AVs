...
model = YOLO('/home/stu12/s11/ak1825/idai710/Project/yolov8n.pt')

bbox_dir = '/home/stu12/s11/ak1825/CSCI_files/img_test/Annotations'
annotated_dir = '/home/stu12/s11/ak1825/CSCI_files/img_test/labeled_images'
Path(bbox_dir).mkdir(parents=True, exist_ok=True)
Path(annotated_dir).mkdir(parents=True, exist_ok=True)

image_dir = '/home/stu12/s11/ak1825/CSCI_files/training/image_2'
